 ...
 */
z3::expr FA::to_expr(z3::context& ctx) {
        ...
        z3::expr_vector state_items(ctx); // consistent_items
        ...
        // consitent phi
        z3::expr consistent_phi = z3::mk_and(state_items);
        ...
        std::ofstream out2("sigma.smt");
        out2 << sum_phi << std::endl;
        out2.close();


        z3::expr phi = consistent_phi && connected_phi && sum_phi;
