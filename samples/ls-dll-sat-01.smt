...
(define-fun lsls 
	((?in Ldll_t) (?dt1 Int) (?len1 Int) (?out Ldll_t) (?dt2 Int) (?len2 Int)) 
	Space 
	(tospace 
		(or 
...
;; declare variables
(declare-fun y_emp () Ldll_t)
(declare-fun w_emp () Ldll_t)
(declare-fun z_emp () Ldll_t)
(declare-fun d1 () Int)
(declare-fun d2 () Int)
(declare-fun n1 () Int)
(declare-fun n2 () Int)
